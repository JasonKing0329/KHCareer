...
public class FoldableLayout extends RelativeLayout {
    ...
    public ImageView getImageCoverView() {
    	return mImageViewAbove;
    }

    public ImageView getImageDetailView() {
    	return mImageViewBelow;
    }

    private void setupView(Context context) {
        setClipChildren(false);
        mRootView = LayoutInflater.from(context).inflate(R.layout.layout_opensource_foldablelayout, this, true);
    ...
    public void setupViews(ViewGroup coverView, ViewGroup detailView, int coverHeight) {
    	mViewGroupCover = coverView;
    	mViewGroupDetail = detailView;
        mContentLayout.addView(mViewGroupCover);
        mContentLayout.addView(mViewGroupDetail);
        mViewGroupDetail.setVisibility(GONE);
        ...
        if (!mIsAnimating) {
            ...
            animator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationStart(Animator animation) {
                    mFoldListener.onFoldStart(FoldableLayout.this);
                    mIsAnimating = true;
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    mIsFolded = true;
                    mIsAnimating = false;
                    mFoldListener.onFoldEnd(FoldableLayout.this);
                }
    ...
    public void unfoldWithAnimation() {
        if (!mIsAnimating) {
            ...
            animator.addListener(new Animator.AnimatorListener() {
                @Override
                public void onAnimationStart(Animator animation) {
                    mFoldListener.onUnFoldStart(FoldableLayout.this);
                    mIsAnimating = true;
                    setImageBackground(mImageViewBelow, new BitmapDrawable(getResources(), mDetailTopBitmap));
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    mIsFolded = false;
                    mIsAnimating = false;
                    mFoldListener.onUnFoldEnd(FoldableLayout.this);
                }
    ...
    public interface FoldListener {
         ...
         */
        void onUnFoldStart(FoldableLayout layout);

        /**
         * Dispatch when un foldWithAnimation end.
         */
        void onUnFoldEnd(FoldableLayout layout);

        /**
         * Dispatch when foldWithAnimation start.
         */
        void onFoldStart(FoldableLayout layout);

        /**
         * Dispatch when foldWithAnimation end.
         */
        void onFoldEnd(FoldableLayout layout);
    }
