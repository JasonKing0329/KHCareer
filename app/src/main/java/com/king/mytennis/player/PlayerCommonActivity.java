...
public class PlayerCommonActivity extends BaseActivity implements ICommonView {
    ...
    private Map<MultiUser, com.king.mytennis.view_v_7_0.model.PlayerBean> pbMap;
    ...
    private void loadH2hs() {
        mPresenter.loadH2hs(this, playerBean.getNameChn());
    }
    ...
    public void onUserH2hLoaded(MultiUser user, int win, int lose) {
        ...
        // 组装详情页需要的bean
        com.king.mytennis.view_v_7_0.model.PlayerBean pb = new com.king.mytennis.view_v_7_0.model.PlayerBean();
