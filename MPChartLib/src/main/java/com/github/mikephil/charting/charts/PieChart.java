...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    private boolean mDrawLegendEnabled = true;
    ...
    /**
     * 不画右上角的 color-value 列表说明
     * @param mDrawLegendEnabled
     */
    public void setDrawLegendEnabled(boolean mDrawLegendEnabled) {
        this.mDrawLegendEnabled = mDrawLegendEnabled;
    }
}
